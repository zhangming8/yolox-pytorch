...
sys.path.append(".")
from models.ops import ResLayer
from models.backbone.resnet import Bottleneck as _Bottleneck
...
if __name__ == "__main__":
    ...
    m = ResNeXt(depth=50, out_indices=[1, 2, 3], groups=32, base_width=4)
    m.eval()
