...
python train.py gpus='0' backbone="CSPDarknet-s" num_epochs=300 exp_id="coco_CSPDarknet-s_640x640" use_amp=False val_intervals=1 data_num_workers=4 load_model="f:/weights/yolox-s.pth" resume=False  dataset_path=D:/coco_dataset
